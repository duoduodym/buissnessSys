      ...
      <template slot="column">
        ...
        <el-table-column fixed="left" label="操作">
          <template slot-scope="scope">
            ...
            <el-button type="text" size="small" @click="onBinding(scope.row)" class="table-btn-blue">绑定</el-button>
            <el-button type="text" size="small" class="table-btn-red">停用</el-button>
...
import { getRoles,delEmployees} from "@/request/apis/cmpMng";
export default {
  components: {
    pagePanel,
    detail,
