			...
			<el-row style="margin-top:20px">
				<el-col :span="12">
					<el-form-item label="企业名称" prop="name">
						<el-input v-model="ruleForm.newPsd" placeholder="请输入企业名称"></el-input>
					</el-form-item>
				</el-col>
			</el-row>
			<el-row>
				<el-col :span="12">
					<el-form-item label="企业规模">
						<el-select v-model="ruleForm.qygm" placeholder="企业规模">
			...
			<el-row>
				<el-col :span="12">
					<el-form-item label="企业地址" prop="name">
						<el-input v-model="ruleForm.newPsd" placeholder="请输入企业地址"></el-input>
					</el-form-item>
				</el-col>
			</el-row>
            <el-row>
